/*
	Handles keeping track of a current mode, which would be some state for the program.
	For example, with the BinaryTree, this may be:
		- A given operation: "in-order traversal", "pre-order traversal"
		- A given state: "building", "starting", ...
*/
