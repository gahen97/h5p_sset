// Changing this to work with my ExercisesCode server, so that any exercise & video can easily be added
// together ... just by changing name of video & inserting new code

// new code

const EXERCISE_MAIN = "./assets/exercise";
...
//      if (self.mainLibrary.displayUsingIframe()) {
      h5pContainer = '<div class="h5p-iframe-wrapper"> <iframe id="h5p-iframe-1" class="h5p-iframe" data-content-id="1" style="height:1px; margin-bottom:1px; width: 80%; margin: auto;" src="about:blank" frameBorder="0" scrolling="no"></iframe> </div>';
...
// new code
      var exercise;
      var exerPath = EXERCISE_MAIN + "/" + currentContentName + ".html";
      exercise = '<div ><iframe style="padding-left:50; margin-top:40px; min-width: 700px; width:60%; float: left; position: relative; left: 20%;" src="' + exerPath + '" frameBorder="0" scrolling="no" id="exercise"></iframe></div>';
//till here
