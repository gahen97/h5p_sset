...
// new code
      ...
      exercise = '<div ><iframe style="padding-left:50; margin-top:40px; width:900px; float: left; position: relative; left: 25%;" src="' + exerPath + '" frameBorder="0" scrolling="no" id="exercise"></iframe></div>';
//till here
