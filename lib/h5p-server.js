...
//      if (self.mainLibrary.displayUsingIframe()) {
      h5pContainer = '<div class./assets/exercise/skiplist-iii.html="h5p-iframe-wrapper"> <iframe id="h5p-iframe-1" class="h5p-iframe" data-content-id="1" style="height:1px; margin-bottom:1px; width: 80%; margin: auto;" src="about:blank" frameBorder="0" scrolling="no"></iframe> </div>';
